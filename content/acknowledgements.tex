...
\textbf{Grammarly} was used for grammatical correction and text formatting consistency throughout the writing process, helping to ensure clarity and writing standards.

\vspace{0.5cm}

\textbf{DeepL} was utilized for translation assistance between Catalan, Spanish, and English.

\vspace{0.5cm}

The Cognitive Contribution License framework and badge generation tool are available at \href{https://santifu.github.io/ccl/generator.html}{Cognitive Contribution Lable (CCL)}. licensed under CC BY-NC-SA 4.0 – the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License.
...
Finally, I acknowledge that while this thesis represents my individual academic work, it builds upon shared knowledge, tools, and practices developed through collaborative engagement. Any contributions this work makes to understanding human-machine interaction in creative contexts should be understood as extending this ongoing collective inquiry led by anyone and any work referenced along this thesis.
